...
ls
ls "%{_sourcedir}"
cmake -B build -S "%{_sourcedir}" -DCMAKE_BUILD_TYPE='Release' -DCMAKE_INSTALL_PREFIX="/usr/bin/%{name}" -DCMAKE_CXX_FLAGS="-ffat-lto-objects -Wno-builtin-macro-redefined" -DCMAKE_C_FLAGS="-Wno-builtin-macro-redefined"
cmake --build build
